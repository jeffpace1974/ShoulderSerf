...
app = Flask(__name__)
app.secret_key = 'sserf-lewis-search-key'
...
def concept_search():
    ...
    try:
        ...
        # Generate search strategies for response metadata
        search_queries = concept_analyzer.generate_search_queries(analysis)
        
        # Use the new concept search method for better semantic matching
        all_results = db.search_concept(analysis, per_page * 5)
